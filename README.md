...
Отностительно основной ветки разрабоки изменен процесс сборки контейнеров, снижено количество оверлеев, актуализированные базовые образы Go (1.24rc1) и Alma Linux (3.21) при сохранении возможности использования предыдущих версий.
