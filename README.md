...
:white_check_mark: **Контейнеры поддерживают файл конфигурации для AmneziaWG 1.5, 2.0, 3.0**. 
Используйте в конфиге awg0.conf параметры I1-I5 для версии 1.5 и 2.0. Описание [тут](https://docs.amnezia.org/ru/documentation/instructions/new-amneziawg-selfhosted/). **Для версии 3.0** используйте дополнительные параметры HeaderProtectionKey, ContentPaddingAddition и другие динамические переменные. 
