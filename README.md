...
**Относительно основной ветки разрабоки изменен процесс сборки контейнеров, снижено количество оверлеев, актуализированные базовые образы Go (1.24rc1) и Alma Linux (3.21) при сохранении возможности использования предыдущих версий.**
Обновленная инструкция по сборке будет опубликована позже. Процесс установки готовых контейнеров не изменился по сравнению с базовой инструкцией.

В данном репозитории рассматривается работа MikroTik RouterOS V7.16.2+ с проектом [Amnezia VPN](https://github.com/amnezia-vpn). В процессе настройки, относительно вашего оборудования, следует выбрать вариант реализации с [контейнером](https://help.mikrotik.com/docs/display/ROS/Container) внутри RouterOS или без контейнера. 
...
* [Вариант №1. RouterOS с контейнером](#R_AWG)
	- [Сборка контейнера на Linux](#MikroTik_container_1)
