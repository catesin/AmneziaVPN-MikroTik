...
- 123.123.123.123/32 (адрес из поля [Peer] => Endpoint в конфигурации клиента AWG. Фактически это адрес куда будет подключаться клиент)
- 10.8.1.0/24 (сеть из поля [Interface] => Address в конфигурации клиента AWG. В последнем октете ставим "0" и маску /24)
